...
| `class-diagram` | Classes, interfaces, enums, members, inheritance, realization, and associations |
...
- `classDiagram` → `class-diagram`; types, members, multiplicities, and UML relationship kinds retain meaning, not Mermaid style.
