...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.class-diagram': ['A class diagram generated by Archify.', '由 Archify 生成的类图。'],
  ...
  'legend.class-diagram.inheritance': ['Inheritance', '继承'],
  'legend.class-diagram.realization': ['Interface realization', '接口实现'],
  'legend.class-diagram.dependency': ['Dependency', '依赖'],
  'legend.class-diagram.association': ['Association', '关联'],
  'legend.class-diagram.aggregation': ['Aggregation', '聚合'],
  'legend.class-diagram.composition': ['Composition', '组合'],
